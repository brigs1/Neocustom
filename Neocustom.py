...
_CITATION = """\
@article{Jaume2019NeocustomAD,
  title={Neocustom: A Dataset for Form Understanding in Noisy Scanned Documents},
...
"""
_DESCRIPTION = """\
https://github.com/brigs1/Neocustom/
"""
...
class Neocustom(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        NeocustomConfig(name="Neocustom", version=datasets.Version("1.0.0"), description="Neocustom dataset"),
    ]
    ...
    def _info(self):
        return datasets.DatasetInfo(
            ...
            homepage="https://github.com/brigs1/Neocustom",
            citation=_CITATION,
        )
